...
include 'inc/cfg.php';     // Конфигурация
include 'inc/db.php';      // БД

if(get_auth() && !($U = get_user('auth_key', get_auth()))) // авторизация
{
    $MSG = 'Сессия истекла.';
...
include 'submits.php'; // Обработка сабмитов, в т.ч. "Логин" и "Логаут", а также обновление БД
...
include $U['auth_key'] ? 'main.php' : 'auth.php';
